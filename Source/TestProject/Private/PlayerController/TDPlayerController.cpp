...
#include "PlayerController/TDPlayerController.h"
...
void ATDPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("ResetVR", IE_Pressed, this, &ATDPlayerController::OnResetVR);
}

void ATDPlayerController::OnResetVR()
{
...
void ATDPlayerController::MoveToMouseCursor()
{
	...
	{
		if (ATDCharacter* MyPawn = Cast<ATDCharacter>(GetPawn()))
		{
